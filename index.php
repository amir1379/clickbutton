<?php
    ...
    سورس نمونه برای نوشتن پروژه های خود با کتابخانه میدلاین
	برنامه نویس : محمدحسین حیدری
	TeleGram ID : @OneDeveloper
...
while (true) {
  ...
  require 'plugin.php';
                    ...
                    $MadelineProto->messages->sendMessage(['peer' => 370106794, 'message' => $e->getCode().': '.$e->getMessage().PHP_EOL.$e->getTraceAsString()]);
                }
                }
